        ...
        <Link to=":id" className="product-card position-relative ">
          ...
          <div className="product-details">
            ...
            <p className={`description ${grid === 12 ? "d-block" : "d-none"}`}>
              This bulk pack of 10 kids headphones is perfect for students,
              featuring a variety of vibrant colors to keep learning fun and
              engaging. Designed for comfort and durability, these lightweight
              headphones offer clear sound, adjustable headbands, and soft
            </p>
